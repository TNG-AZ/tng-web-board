...
namespace TNG.Web.Board.Data.Migrations
{
    ...
    [Migration("20260216105530_addEmailDomainToQueue")]
    partial class addEmailDomainToQueue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.Raffle", b =>
                {
                    ...
                    b.Property<string>("FundraiserCause")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ImageUrl")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("RaffleEntryCostCents")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.RaffleEntry", b =>
                {
                    b.Property<Guid>("RaffleEntryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("PrivateDonation")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.ScheduledEmail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("EmailDomain")
                        .HasColumnType("int");

                    b.Property<string>("EventId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("EventRecipientFilter")
                        .HasColumnType("int");

                    b.Property<string>("RecipientsCSV")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("SendAtDateTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.VolunteerEventSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VolunteerEventSlots");
                });

            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.VolunteerPosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool?>("RequireRoleApproval")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.VolunteerPositionRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("VolunteerPositionRoleId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("VolunteerPositionRoleId");

                    b.ToTable("VolunteerPositionRoles");
                });

            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.VolunteerRoleMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VolunteerRoleMembers");
                });

            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.VolunteerSlotMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VolunteerSlotMembers");
                });
            ...
            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.Raffle", b =>
                {
                    b.HasOne("TNG.Web.Board.Data.DTOs.Member", "Winner")
                        .WithMany("RaffleWins")
            ...
            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.RaffleEntry", b =>
                {
                    ...
                    b.HasOne("TNG.Web.Board.Data.DTOs.Raffle", "Raffle")
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.VolunteerEventSlot", b =>
                {
                    b.HasOne("TNG.Web.Board.Data.DTOs.VolunteerPosition", "Position")
                        .WithMany("EventSlots")
            ...
            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.VolunteerPosition", b =>
                {
                    b.HasOne("TNG.Web.Board.Data.DTOs.VolunteerPositionRole", "RequiredRole")
                        .WithMany()
            ...
            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.VolunteerPositionRole", b =>
                {
                    b.HasOne("TNG.Web.Board.Data.DTOs.VolunteerPositionRole", null)
                        .WithMany("Roles")
                        .HasForeignKey("VolunteerPositionRoleId");
                });
            ...
            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.VolunteerRoleMember", b =>
                {
                    ...
                    b.HasOne("TNG.Web.Board.Data.DTOs.VolunteerPositionRole", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TNG.Web.Board.Data.DTOs.VolunteerSlotMember", b =>
                {
                    ...
                    b.HasOne("TNG.Web.Board.Data.DTOs.VolunteerEventSlot", "Slot")
